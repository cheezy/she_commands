defmodule SheCommands.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind she_commands", "esbuild she_commands"],
      "assets.deploy": [
        "tailwind she_commands --minify",
        "esbuild she_commands --minify",
        "phx.digest"
      ],
